    ...
    <section id="overview" className="bg-[var(--rt-surface-soft)]">
      <div className="mx-auto max-w-7xl px-6 py-20 sm:px-10 lg:px-12">
        ...
        <div className="mx-auto mt-12 flex max-w-4xl flex-col gap-5">
          {steps.map((step) => {
            const isExpanded = expandedSteps[step.title] ?? false;
              ...
              >
                <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:gap-6">
                  <div className="flex-1 text-center sm:text-left">
                    ...
                    <p
                      className={`mt-3 text-base leading-7 text-[color:color-mix(in_srgb,var(--rt-green)_80%,white)] ${
                    ...
                    <button
                      ...
                      className="mt-3 inline-flex min-h-11 items-center justify-center text-sm font-semibold text-[var(--rt-green)] underline decoration-[color:rgba(4,61,49,0.24)] underline-offset-4 transition-colors hover:text-[var(--rt-green-2)] sm:hidden"
                    >
